        ...
        <table class="table table-custom ">
          ...
          <tbody class="" id="tabla">
            ...
            <tr>
              ...
              <td>
                <a href="borrarEstudiantes.php?id=<?=$val['id']?>&req=delete" class="btn btn-danger">Borrar</a>
              </td>
              <td>
                <a href="editarEstudiantes.php?id=<?=$val['id']?>" class="btn btn-warning">Editar</a>
              </td>
            </tr>
          </tbody>
            <?php } ?>
            ...
            <form class="col d-flex flex-wrap" action="registrarEstudiantes.php" method="post">
              ...
              <div class="mb-1 col-12">
                ...
                <select name="ingles" id="ingles">
                    <option value="Bennieger">Bennieger</option>
                    <option value="Middler">Middler</option>
